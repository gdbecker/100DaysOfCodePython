...
data = soup.findAll(name="ul", class_="photo-cards photo-cards_wow photo-cards_short")
address_list = []
price_list = []
link_list = []
...
for article in soup.select(selector="ul li article"):
    ...
    for div in article.findAll(name="div", class_="list-card-price"):
        price_list.append(div.getText())
...
for n in range(len(address_list)):
    address_field = driver.find_element(By.CSS_SELECTOR, "#mG61Hd > div.RH5hzf.RLS9Fe > div > div.o3Dpx > div:nth-child(1) > div > div > div.AgroKb > div > div.aCsJod.oJeWuf > div > div.Xb9hP > input")
    address_field.send_keys(address_list[n])

    price_field = driver.find_element(By.CSS_SELECTOR, "#mG61Hd > div.RH5hzf.RLS9Fe > div > div.o3Dpx > div:nth-child(2) > div > div > div.AgroKb > div > div.aCsJod.oJeWuf > div > div.Xb9hP > input")
    price_field.send_keys(price_list[n])

    link_field = driver.find_element(By.CSS_SELECTOR, "#mG61Hd > div.RH5hzf.RLS9Fe > div > div.o3Dpx > div:nth-child(3) > div > div > div.AgroKb > div > div.aCsJod.oJeWuf > div > div.Xb9hP > input")
    ...
    submit_another_button = driver.find_element(By.CSS_SELECTOR, "body > div.Uc2NEf > div:nth-child(2) > div.RH5hzf.RLS9Fe > div > div.c2gzEf > a")
